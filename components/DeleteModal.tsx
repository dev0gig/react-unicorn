  ...
  return (
    <>
      {isOpen && (
        ...
        >
          <div
            className="bg-neutral-800 rounded-2xl w-full max-w-md flex flex-col border border-neutral-700"
          ...
          >
            ...
            <footer className="flex justify-end items-center p-4 bg-neutral-900/50 rounded-b-2xl">
              ...
              <button
                ...
                className="bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-6 rounded-lg transition-all duration-200 flex items-center disabled:bg-neutral-600 disabled:cursor-not-allowed"
              >
                <i className="material-icons mr-2 text-base">warning_amber</i>
                Löschen
              </button>
            </footer>
          </div>
